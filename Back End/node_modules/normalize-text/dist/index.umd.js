(function (global, factory) {
    ...
    var capitalizeFirstLetter$1 = capitalizeFirstLetter;
    ...
    var normalizeDiacritics$1 = normalizeDiacritics;
    ...
    var normalizeWhiteSpaces$1 = normalizeWhiteSpaces;
    ...
    var splitWords = function (text) {
        return normalizeWhiteSpaces$1(text.toLocaleLowerCase()).split(' ');
    };
    /**
    ...
    var capitalizeWordExcept = function (exceptions) { return function (word) {
        return exceptions.indexOf(word) > -1 ? word : capitalizeFirstLetter$1(word);
    }; };
    /**
    ...
    var normalizeName$1 = normalizeName;
     ...
     * @returns {string}
     */
    var normalizeParagraph = /*#__PURE__*/ pipe(normalizeWhiteSpaces$1, addPeriodAtEnd, capitalizeFirstLetter$1);
    var normalizeParagraph$1 = normalizeParagraph;
     ...
     * @returns {string}
     */
    var normalizeText = /*#__PURE__*/ pipe(resolveToText, normalizeDiacritics$1, normalizeWhiteSpaces$1, transformToLowerCase);
    var normalizeText$1 = normalizeText;

    exports.capitalizeFirstLetter = capitalizeFirstLetter$1;
    exports['default'] = normalizeText$1;
    exports.normalizeDiacritics = normalizeDiacritics$1;
    exports.normalizeName = normalizeName$1;
    exports.normalizeParagraph = normalizeParagraph$1;
    exports.normalizeText = normalizeText$1;
    exports.normalizeWhiteSpaces = normalizeWhiteSpaces$1;
