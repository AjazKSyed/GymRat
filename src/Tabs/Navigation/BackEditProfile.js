    ...
    <View>
      <TouchableOpacity
        ...
        <Svg width="46" height="45" fill="none">
          <Path d="M27.0586 30.4414L18.9409 22.5002L27.0586 14.5591" stroke= { theme.gradientR} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </Svg>
        </TouchableOpacity>
    </View>
  );
};
export default BackEditProfile;
