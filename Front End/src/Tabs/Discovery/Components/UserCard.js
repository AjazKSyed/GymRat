    ...
    return (
        <View>
            <TouchableOpacity
                ...
                onPress={() =>
                    navigation.navigate("Profile", {itemId: props.listId, firstName: props.firstName, lastName: props.lastName, userLong: props.longitude, userLat: props.latitude, myLong: props.my_longitude, myLat: props.my_latitude})
                }
            >
