...
import FriendHeader from '../../Navigation/FriendHeader2';
import BackDiscovery from '../../Navigation/BackDiscovery';
...
export default function MessageProfile({route, navigation}) {
